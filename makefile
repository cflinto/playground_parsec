...
READ_HORIZONTAL_SLICES_BLOCK_NUM ?= 1024
READ_HORIZONTAL_SLICES_THREAD_NUM ?= 256
WRITE_HORIZONTAL_SLICES_BLOCK_NUM ?= 1024
WRITE_HORIZONTAL_SLICES_THREAD_NUM ?= 256
READ_VERTICAL_SLICES_BLOCK_NUM ?= 1024
...
$(OUTPUT_FILE): $(C_FILE) $(O_FILE)
	...
	$(NVCC) $(CFLAGS) $(O_FILE) $(C_FILE) $(PARSEC_INCLUDES) $(PARSEC_LIBS) -o $(OUTPUT_FILE) $(CUDA_LIBS) $(LDFLAGS) \
		-DREAD_HORIZONTAL_SLICES_BLOCK_NUM=${READ_HORIZONTAL_SLICES_BLOCK_NUM} -DREAD_HORIZONTAL_SLICES_THREAD_NUM=${READ_HORIZONTAL_SLICES_THREAD_NUM} -DWRITE_HORIZONTAL_SLICES_BLOCK_NUM=${WRITE_HORIZONTAL_SLICES_BLOCK_NUM} -DWRITE_HORIZONTAL_SLICES_THREAD_NUM=${WRITE_HORIZONTAL_SLICES_THREAD_NUM} -DREAD_VERTICAL_SLICES_BLOCK_NUM=${READ_VERTICAL_SLICES_BLOCK_NUM} -DREAD_VERTICAL_SLICES_THREAD_NUM=${READ_VERTICAL_SLICES_THREAD_NUM}
